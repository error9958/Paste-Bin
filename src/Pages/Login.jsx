...
import { SignIn } from "../Scripts/UtilityMethods";
...
function Login() {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    SignIn(email, password, flag).then(() => {
      navigate("/", { replace: true });
    });
  };
  return (
    <div className=" h-screen bg-whitesmoke flex items-center shadow-2xl  ">
      <form
        onSubmit={(e) => {
          submitHandler(e);
        }}
      ...
      >
        ...
        <button
          type="submit"
          className="bg-blkv hover:bg-green-500 text-white font-semibold text-lg px-8 py-4"
        >
          LOGIN
        </button>
      </form>
